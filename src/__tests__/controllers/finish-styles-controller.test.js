...
jest.mock("../../repositories/finish-styles-repository", () => ({
	create: jest.fn(),
	get: jest.fn(),
	getById: jest.fn(),
	update: jest.fn(),
...
const repository = require("../../repositories/finish-styles-repository");
const controller = require("../../controllers/finish-styles-controller");

describe("Finish Styles Controller", () => {
	let req, res;
	beforeEach(() => {
