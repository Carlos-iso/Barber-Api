...
jest.mock("../../repositories/fade-types-repository", () => ({
	create: jest.fn(),
	get: jest.fn(),
	getById: jest.fn(),
	update: jest.fn(),
...
const repository = require("../../repositories/fade-types-repository");
const controller = require("../../controllers/fade-types-controller");

describe("Fade Types Controller", () => {
	let req, res;
	beforeEach(() => {
