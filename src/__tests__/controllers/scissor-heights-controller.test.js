...
jest.mock("../../repositories/scissor-heights-repository", () => ({
	create: jest.fn(),
	get: jest.fn(),
	getById: jest.fn(),
	update: jest.fn(),
...
const repository = require("../../repositories/scissor-heights-repository");
const controller = require("../../controllers/scissor-heights-controller");

describe("Scissor Heights Controller", () => {
	let req, res;
	beforeEach(() => {
