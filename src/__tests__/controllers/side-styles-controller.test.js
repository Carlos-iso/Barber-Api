...
jest.mock("../../repositories/side-styles-repository", () => ({
	create: jest.fn(),
	get: jest.fn(),
	getById: jest.fn(),
	update: jest.fn(),
...
const repository = require("../../repositories/side-styles-repository");
const controller = require("../../controllers/side-styles-controller");

describe("Side Styles Controller", () => {
	let req, res;
	beforeEach(() => {
